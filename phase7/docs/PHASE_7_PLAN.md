...
| 7.8 Ambient voice wearable (household voice learning; canon since 2026-09-05, operator decision, scope per idea doc §8) | Owner's voice first: enrolled from the Main PC headset mic; owner-versus-not speaker verification measured on held-out recordings at a pre-registered rate | `MEASURED BASELINE (same-day sanity EER 0.00 % on 14 same-day pieces vs 78 public negatives — not the M0b band; the later-day evaluation flips this row)` | enrollment: 3 read clips + 3 natural pieces of recording 01 (185.3 s of speech); sanity pieces from recording 02; threshold 0.3461; 2026-09-06, this commit | `ROADMAP.md:122`; `phase4/docs/BEYOND_PHASE7_VOICE_WEARABLE.md` §8 |
