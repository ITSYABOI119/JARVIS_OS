...
| 7.8 | MS1 — the extractor bake-off on the RTX 2070: Gemma 4 E2B, Llama 3.1 8B at 4-bit, an encoder-style extractor, over the synthetic corpus; one chosen by JSON validity ≥ 99 % then F1, floor 0.60 | `NOT STARTED` | — | `phase7/docs/PHASE_7_MEMORY_DESIGN.md` §0, §8, §11 |
