...
| 7.8 | MS0 — the memory store and its rules: schema, the predicate registry, rules R1–R7, audit rows, the purge, the benchmark harness and the synthetic corpus, driven by oracle candidates | `NOT STARTED` | — | `phase7/docs/PHASE_7_MEMORY_DESIGN.md` §3, §4, §8, §11 |
