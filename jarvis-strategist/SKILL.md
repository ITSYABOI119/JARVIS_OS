...
then get to explore for context say:
  ...
  - Read phase7/docs/PHASE_7_PLAN.md §0 FIRST — the ACTIVE phase's live status board (stood up 2026-09-05, `ae9664c`; a cell reads DONE only with a commit hash + date; nothing on it is done yet; the first arc and candidate goal 8 are the OPERATOR'S pending decisions — never pick them)
