...
- **Total (phases):** 112,312 LOC, 307 code files, 93 test files (714 tracked files repo-wide)
- **Phase 4 console (`phase4/console/`):** 15-file browser UI — 6 `.jsx` + `telemetry.js` + `index.html` + the vendored DS runtime (`_ds_bundle.js`, `styles.css`, 4 `tokens/*.css`) + `test_console_honesty.py` (honesty gate). The web files are not counted in the `.c/.h/.py` LOC above.
