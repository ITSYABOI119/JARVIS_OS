...
| Shared context pool (Phase 5 G2/M0) | — | DONE | shared_context.c/h, test_shared_context.c | host CI: 22 PASS (seqlock torn-read-safe under TSan, writer + 1/2/4/8 readers; + O2) |
| G3 retrieval scorer+assembler (Phase 5 G3/M0) | — | DONE | g3_retrieval.c/h, test_g3_retrieval.c | host CI: 19 PASS (exact-key+recency select, byte-exact preamble, truncation 0xAA-canary, *_len NUL-safety) |
| **Total** | | | **128 code files (43 test)** | **424+ test asserts, ~35,700 LOC** |
