...
| **seL4 build, bare metal, 1T AVX2** (M1, 2026-06-17) | — | **Gemma 4 E2B ~1.53 tok/s** (vs ~0.2 scalar, ~7.6×; ~90% of native 1T). NOTE: the three rows above are the NATIVE dev engine — do not conflate with this deployed seL4-build figure. |
...
- **Decision records (ADRs):** `docs/decisions/` — dynamic-scaling removal (2026-04-17), 30-day soak deferral + TurboQuant/RotorQuant deferral (2026-06-15), GPU-inference deferral (2026-06-16), x86 verification stance (2026-06-16)
