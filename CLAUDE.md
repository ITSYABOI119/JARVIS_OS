...
- **Golden pcap generator:** `phase3/scripts/gen_golden_pcap.py` — regenerates `golden.pcap` from the JSON (guards `struct.calcsize==216` (v3) + the canonical 0xCBF43926 CRC vector); CI step "Phase 4: Golden telemetry fixture up-to-date" fails on drift.
