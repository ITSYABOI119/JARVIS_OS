...
| Phase 6 | IN PLANNING (kickoff) | Months 36+ | Butler — plan (`phase6/docs/PHASE_6_PLAN.md`) + the keystone goal doc **`PHASE_6_GOAL_K_IT_ACTS.md` authored 2026-07-04** (K = "it-acts" spine + live SHIELD, closes SEC-039, decomposed K/M0–M4); keystone-first, security-foregrounded (control-IN hard-gated); activates the gated Phase-5 #4/#5; **plan-first — NO code yet, both docs awaiting strategist/user review** |
