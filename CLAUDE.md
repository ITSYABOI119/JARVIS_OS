...
| **seL4 build, bare metal, 1T AVX2** (M1, 2026-06-17) | — | **Gemma 4 E2B ~1.53 tok/s** (vs ~0.2 scalar, ~7.6×; ~90% of native 1T). Held under **M2 SMP** (`NUM_NODES=2`, 2026-06-17) — within ~0.2%, no 1T penalty. NOTE: the three rows above are the NATIVE dev engine — do not conflate with this deployed seL4-build figure. |
