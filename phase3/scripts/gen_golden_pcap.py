...
Guards before writing: struct.calcsize(fmt)==262 (both FMT and the fixture's
...
from telemetry_fixture import FMT_V12, build_pcap_many, frame_to_packet  # noqa: E402
...
def main():
    ...
    assert struct.calcsize(FMT_V12) == 262, "FMT_V12 no longer 262 bytes (v12)"
    assert struct.calcsize(meta['fmt']) == 262, "meta.fmt no longer 262 bytes (v12)"
    assert meta['size'] == 262, "meta.size != 262"
