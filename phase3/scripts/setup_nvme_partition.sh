...
echo ""
echo -e "${BOLD}Next steps for the seL4 rootserver:${NC}"
echo ""
echo "  The NVMe AHCI driver needs to read partition ${NEW_PART_NUM} on the NVMe."
echo "  Update phase3/src/drivers/ahci.c or phase3/src/sel4/main_x86.c:"
echo ""
echo "    #define JARVIS_MODEL_PARTITION  ${NEW_PART_NUM}   /* FAT32 JARVIS_DATA */"
echo "    #define JARVIS_MODEL_FILENAME   \"MODEL.GUF\""
echo ""
echo "  Partition UUID (for verification in rootserver):"
echo "    $PART_UUID"
echo ""
echo "See: phase3/docs/plans/2026-04-03-grub-model-loading.md"
echo ""
