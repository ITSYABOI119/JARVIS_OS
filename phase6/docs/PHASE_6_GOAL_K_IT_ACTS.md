...
**Status:** 📝 PLAN-FIRST (authored 2026-07-04) — this decomposition is itself for **strategist review before any K/M0 code**. No code, no tests, no CI steps, no flag flips exist for K yet; every flag/LBA/API named below is PROPOSED.
**Date:** 2026-07-04
...
### K/M1 — box: LINK `shield.c` into PA + the induced-BLOCK proof — **CLOSES SEC-039**
